...
COMMAND="cgexec -g cpu,net_cls,blkio,pids,perf_event,hugetlb,freezer:$PERF_EVENT_NATIVECGROUP $KVAZAAR --threads $THREADS $INPUTRES $KVAZAAR_PARAMETERS -i - -o - < $INPUT > $OUTPUT"
echo $COMMAND
eval $COMMAND
