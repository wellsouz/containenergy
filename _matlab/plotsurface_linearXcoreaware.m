...
for file=0:3
  ...
  h(1)=surf(frequencies_vector, cores_vector, energymatrix_il,'EdgeColor', 'blue', 'FaceColor', [200,1,255]/255, 'Marker', '.' );
  hold on

  #h(2)=surf(frequencies_vector, cores_vector, energymatrix_ic,'EdgeColor', 'white', 'FaceColor', [255,100,0]/255, 'Marker', '.' );
  hold on

  h(3)=surf(frequencies_vector, cores_vector, energymatrix_pl, 'EdgeColor', 'black', 'FaceColor', [1,255,200]/255, 'Marker', '.'); 
#  hold on

#  h(4)=surf(frequencies_vector, cores_vector, energymatrix_pc, 'EdgeColor', 'black', 'FaceColor', [1,255,200]/255, 'Marker', '.'); 
  hold off
  
  title ("Energy (J) / Idle X Linear Power Off X Core-aware Power Off ");
